    ...
    return(
        <div className="flex flex-col items-center p-20">
            ...
            <div className="flex gap-5 pt-4 w-full justify-center flex-wrap">
                <Link className="bg-azul-principal p-2 text-white rounded-xl font-semibold" to={'/Aquiro'}>Form</Link>
                <Link className="bg-azul-principal p-2 text-white rounded-xl font-semibold" to={'/login'}>Login</Link>
                <Link className="bg-azul-principal p-2 text-white rounded-xl font-semibold" to={'/cadastro'}>Cadastro</Link>
                <Link className="bg-azul-principal p-2 text-white rounded-xl font-semibold" to={'/home/pacientes'}>Pacientes</Link>
                <Link className="bg-azul-principal p-2 text-white rounded-xl font-semibold" to={'/home/prontuario'}>Prontuario</Link>
