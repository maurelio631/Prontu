...
export function Page403() {
    ...
    return (
        <div className="flex flex-col items-center pt-32">
            ...
            <h1 className="text-6xl font-bold text-azul-principal mb-5 text-center">Acesso negado!</h1>
            <p className="text-3xl font-normal text-[#404040] text-center">
                Não encontramos a página que você tentou acessar
            </p>
            <p className="text-2xl font-semibold text-[#404040] text-center">
            ...
            <div className="flex gap-5 pt-4 w-full justify-center flex-wrap">
                <Link
                    className="bg-azul-principal p-3 text-white rounded-full font-semibold w-full max-w-64 text-center"
